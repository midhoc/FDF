...
/*   Updated: 2019/08/05 02:53:19 by hmidoun          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	while (tst)
	{
		...
		tst->y *= 20;
		tst->z *= 20;
		//mlx_pixel_put(mlx_ptr, win_ptr, tst->x +100, tst->y +100,  tst->z * 1500000 + 15000);
		T[y][x].x = (tst->x - tst->y) * cos(3.14/4) + 200;
		T[y][x].y = -tst->z + (tst->x + tst->y) * sin(3.14/9) +200;
